...
describe('CommentSection', () => {
  ...
  it('should list author as unknown if not found', () => {
    commentStore.comments.push(new Comment(3, 1, 1, 'I hate this article', new Date(), null));
    // supplying no user
  ...
  it('should render comments when those are present', () => {
    commentStore.comments.push(new Comment(2, 1, 1, "There, there... It'll be fine.", new Date(), null));
